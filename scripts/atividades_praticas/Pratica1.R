...
###
### 2. Importe o conjunto de dados _alunos.csv_ (material coletado pelo Prof Marcus Nunes - DEST/UFRN) e tente entender o que esse conjunto de dados mostra. Para isso, siga os passos:
